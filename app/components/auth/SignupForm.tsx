        ...
        startIcon={
          <Box sx={{ display: 'flex', alignItems: 'center' }}>
            <svg width="20" height="20" viewBox="0 0 24 24">
              ...
              />
              <path
                d="M12.545 8.255c1.522-0.018 2.932 0.543 4.007 1.589l2.713-2.713c-1.893-1.768-4.366-2.827-6.72-2.827-2.622 0-4.909 1.491-6.007 3.666l4.998 4.998c0.88-1.6 2.516-2.71 4.39-2.748l0.619 0.035z"
                fill="#EA4335"
              />
            </svg>
          </Box>
