    ...
    reducers: {
        ...
        loginSuccess: (state, action) => {
            ...
            try {
                ...
                console.error(
                    'Lỗi khi lưu dữ liệu đăng nhập vào localStorage:',
                    error
                );
            }
        },
        ...
        logout: (state) => {
            ...
            try {
                ...
                console.error(
                    'Lỗi khi xóa dữ liệu đăng nhập từ localStorage:',
                    error
                );
            }
        },
...
export const { loginStart, loginSuccess, loginFailure, logout, clearErrors } =
    authSlice.actions;
